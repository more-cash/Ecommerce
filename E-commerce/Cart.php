...
<body class="scroll-panel">
		...
		<div class="container">
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					$index = 1;
					include("ConnDB.php");
					$sql = "SELECT * FROM carrello where IdUtente = $id";
					...
					if ($result->num_rows > 0) {
						...
						while ($row = $result->fetch_assoc()) {
							...
							echo "<input class='cart_quantity_input' type='number' name='quantity[]' value='$quantity' autocomplete='off' id='quant' size='2'>";
							echo "<a class='cart_quantity_down' onclick='updateQuantity(-1, $index, $price)'> - </a>";
							 "var quntita = document.getElementById('quant')";
							echo "<a class='cart_quantity_down' href='script.php?quantita=quntita'>U </a>";
							echo "</div>";
							echo "</td>";
							...
							echo "<a class='cart_quantity_delete' href='Cancella.php?profile=$codutente'><i class='fa fa-times'></i></a>";
							echo "</td>";
							echo "</tr>";
							echo "</tbody>";
							$sommaPrezzi += $quantit;
							$index++;
								...
								echo "<h2><b>Non hai macchine nel carrello!</b></h2>";
							}
                        ?>
				</table>
			</div>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<?php
								$sommaPrezz = $sommaPrezzi + 50;
								$_SESSION["totale"] = $sommaPrezz;
							?>
						</ul>
							<a class="btn btn-default update" href="Ordine.php">Acquista</a>
	...
	<script>
		function updateQuantity(change, inputIndex, prezzo) {
			...
			calcolaTotale();
			$.ajax({
			url: "script.php", // Il percorso del tuo script PHP
			method: "POST", // Metodo di invio della richiesta, ad esempio POST o GET
			data: {parametro1: inputIndex, parametro2: newQuantity}, // Dati da inviare al server
