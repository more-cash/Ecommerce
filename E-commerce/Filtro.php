							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="Carrello.html">Cart</a></li> 
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#sportcars">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											SportCars
										</a>
									</h4>
								</div>
								<div id="sportcars" class="panel-collapse collapse">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#citycar">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											CityCar
										</a>
									</h4>
				...
				<?php                  
					echo "<div class='col-sm-9 padding-right'>";
						echo "<div class='features_items'><!--features_items-->";
							echo "<h2 class='title text-center'>Macchine disponibili</h2>";  
								echo "<div class='col-sm-4'>";        
									//$utente = $_GET['profilo'];
									include("ConnDB.php");
									$sql = "SELECT * FROM articoli WHERE Marca LIKE '%$Filtro%'";
										...
										while ($row = $result->fetch_assoc()) {
											echo "<div class='product-image-wrapper'>";
												echo "<div class='single-products'>";
													...
													echo "<a href='#' class='btn btn-default add-to-cart'><i class='fa fa-shopping-cart'></i>Aggiungi </a>";
												echo "</div>";
