				...
				<div class="row">
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav" >
                            ...
                            <li><a href="Login.php"><i class="fa fa-crosshairs"></i> Logout</a></li>
						...
						if ($result->num_rows > 0) {
							while ($row = $result->fetch_assoc()) {		
								...
								echo "<div class='productinfo text-center'>";
									...
									echo "<a href='Carrello.php?profile=$codutente'' class='btn btn-default add-to-cart'><i class='fa fa-shopping-cart'></i>Aggiungi </a>";
									echo "<a href='Dettagli.php?profilo=$codutente' class='btn btn-default add-to-cart'>Dettagli </a>";
								echo "</div>";
